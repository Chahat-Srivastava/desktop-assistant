...
def comparison():
    flag=0
    with open(r'C:\Users\MY COMPUTER\Desktop\desktop assistant\Python_project_sem3\datasheet.txt','r') as file:
        for line in file:
            line=line.split(",")
...
bg1=PhotoImage(file=r"C:\Users\MY COMPUTER\Desktop\desktop assistant\Python_project_sem3\Resource used\pat.png")
...
def  signup():
    ...
    if len(P_Number)==10:
        ...
        if password==conform_password:
            try:
                file=open(r"C:\Users\MY COMPUTER\Desktop\desktop assistant\Python_project_sem3\datasheet.txt",'a')
...
img=ImageTk.PhotoImage(Image.open(r"C:\Users\MY COMPUTER\Desktop\desktop assistant\Python_project_sem3\Resource used\login1.png"))
...
def sendmail1():
   ...
   webbrowser.open("http://hangouts.google.com")
